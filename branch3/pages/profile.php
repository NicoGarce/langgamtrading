                                                                ...
                                                                <div class="container pt-3">
                                                                    <div class="d-flex justify-content-center position-relative">
                                                                        <div class="photo-container" data-bs-toggle="modal" data-bs-target=#upload title="Upload Photo">
                                                                            <img src="<?php echo (!empty($result[0]->photo)) ? '../' . $result[0]->photo : '/assets/user_upload/default.png' ?>" alt="photo" class="img-fluid border border-2 rounded-circle" width="250px" height="250px">
                                                                            <span class="overlay">
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script src="../../branch3/includes/change_pass.js"></script>
