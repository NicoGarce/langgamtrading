...
if(isset($_POST['send'])){
    ...
    //Email
    $mail->setFrom('agl.systems.info@gmail.com','Langgam Trading 3RD Branch');
...
<body>
    <div class="container">
        ...
        <p><a href="https://langgamtrading-system.000webhostapp.com/branch3/pages/change_password.php" id="openModalLink">Change Password</a></p>
    </div>
</body>
</html>';
