...
<body>
  <div class="sidebar rounded-5 shadow-lg" id="side_nav">
    ...
    <ul class="list-unstyled px-2">
      ...
      <hr class="text-white">
      <li class="">
        <a href="/langgamtrading/branch1/pages/admin/admin_dashboard.php" class="text-decoration-none px-3 py-2 d-block">
          <i class='bx bxs-dashboard p-2'></i>Dashboard</a>
      </li>
      <li class="">
        <a href="/langgamtrading/branch1/pages/inventory.php" class="text-decoration-none px-3 py-2 d-block">
          <i class='bx bx-clipboard p-2'></i>Inventory</a>
      </li>
      <li class="">
        <a href="/langgamtrading/branch1/pages/orders.php" class="text-decoration-none px-3 py-2 d-block">
          <i class='bx bx-list-ul p-2'></i>Orders</a>
      </li>
      <li class="">
        <a href="/langgamtrading/branch1/pages/voided.php" class="text-decoration-none px-3 py-2 d-block">
        <i class='bx bx-folder-minus p-2'></i>Voided</a>
      </li>
      <li class="">
        <a href="/langgamtrading/branch1/pages/admin/sales.php" class="text-decoration-none px-3 py-2 d-block">
          <i class='bx bx-line-chart p-2'></i>Sales</a>
      </li>
      <li class="">
        <a href="/langgamtrading/branch1/pages/admin/acc_manage.php"class="text-decoration-none px-3 py-2 d-block">
          <i class='bx bxs-user-account p-2'></i>Accounts</a>
      </li>
      <li class="">
        <a href="/langgamtrading/branch1/pages/suppliers.php" class="text-decoration-none px-3 py-2 d-block">
