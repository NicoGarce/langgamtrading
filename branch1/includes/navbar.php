...
<nav class="navbar navbar-expand-md navbar-light gradient-navbar rounded-4 shadow-lg">
    <div class="container-fluid">
        <div class="d-flex justify-content-between d-md-none d-block">
            <button class="btn px-1 py-0 open-btn me-2 text-white"><i class='bx bx-menu'></i></i></button>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0 text-center">
                <li class="nav-item profile">
                    <a class="nav-link active profile-img" aria-current="page" href="/langgamtrading/branch1/pages/profile.php" title="Profile">
                        <img src="<?php echo $image_src; ?>" alt="photo" class="img-fluid border border-2 rounded-circle" width="30px" height="30px">
                    </a>
                    
                    <a class="nav-link active profile-text text-white" aria-current="page" href="/langgamtrading/branch1/pages/profile.php">Profile</a>
                </li>
                ...
                <li class="nav-item logout">
                    ...
                    <a class="nav-link active logout-text text-white" aria-current="page" href="/langgamtrading/includes/logout_b1.php">Logout</a>
                </li>
            </ul>
        </div>
    </div>
