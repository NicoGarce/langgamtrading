                                    ...
                                    <form method="post" id="edit-reg-form<?php echo $result->order_id ?>">
                                        ...
                                        <div class="form-group pt-2">
                                           ...
                                           <!-- <select class="form-control" id="order_type" name="order_type" required title="Order Type">
                                                <?php
                                                    /*
                                                    $databaseValue = $result->order_type; 

                                                    $options = array("In-Store", "Delivery");
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" name="update_order" id="updateStat<?php echo $cnt ?>" class="btn btn-dark">Update</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
