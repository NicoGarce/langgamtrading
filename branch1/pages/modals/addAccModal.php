                    ...
                    <form method="post" id="registration-form">
                        ...
                        <div class="form-group pt-2">
                            <input type="text" class="form-control" id="username" name="username" minlength="6"
                                placeholder="Username (minimum 6 characters)" required autocomplete="username">
                            <span id="username-message"></span>
                        </div>
                        <div class="form-group pt-2">
                            <input type="password" class="form-control" id="password" name="password" minlength="8"
                                placeholder="Password (minimum 8 characters)" required autocomplete="new-password">
                        </div>
                        <div class="form-group pt-2">
...
<script src="../../../branch1/includes/acc_check.js"></script>
