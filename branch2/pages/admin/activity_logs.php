...
require_once('../../../branch2/includes/log_function.php');
...
if (isset($_SESSION['branch']) && $_SESSION['branch'] == 'Branch 1') {
    header('Location: /langgamtrading/branch1/pages/logs.php');
    exit();
...
<head>
    ...
    <title>Activity Logs | Langgam Trading</title>
            ...
            <div class="dashboard-content px-3">
                ...
                <div class="m-0 m-sm-3">
                    ...
                    <div class="container-fluid card p-3 rounded-4">
                        <div id="visibleTable" class="table-responsive pt-2">
                            <table id="table" class="table table-bordered table-striped table-hover">
                                <thead class="text-center">
                                    <tr>
                                        <th class="d-none d-sm-table-cell">#</th>
                                        <th>Activity</th>
                                        <th class="d-none d-sm-table-cell">Table</th>
                                        <th class="d-none d-sm-table-cell">Record ID</th>
                                        <th class="d-none d-sm-table-cell">Date</th>
                                        <th class="d-none d-sm-table-cell">Time</th>
                                        <th class="d-none d-sm-table-cell">User ID</th>
                                        <th>Name</th>
                                        <th class="d-none d-sm-table-cell">Userame</th>
                                        <th><i class='bx bx-info-circle'></i></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $results = $logs->get_log_history();
                                    ...
                                    ?>
                                            <tr class="">
                                                <td class="d-none d-sm-table-cell">
                                                    <?php echo htmlentities($result->action_id); ?>
                                                </td>

                                                <td>
                                                    <?php echo htmlentities($result->action_type); ?>
                                                </td class="d-none d-sm-table-cell">

                                                <td class="d-none d-sm-table-cell">
                                                    <?php echo htmlentities($result->table_name); ?>
                                                </td>

                                                <td class="d-none d-sm-table-cell">
                                                    <?php echo htmlentities($result->record_id); ?>
                                                </td>
                                                ...
                                                <td>
                                                    <?php echo htmlentities($result->full_name); ?>
                                                </td>
                                                <td class="d-none d-sm-table-cell">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="labelEdit">Activity Log Details</h5>
                                                                    ...
                                                                    <form method="post" id="registration-form<?php echo $cnt ?>">
                                                                        <div class="row pt-2">
                                                                            <div class="form-group col-md-3">
                                                                                <label for="action_id" class="label small px-1">Action ID</label>
                                                                                <input type="text" class="form-control" id="action_id<?php echo $cnt ?>" name="action_id" value="<?php echo $result->action_id; ?>" required readonly disabled>
                                                                            </div>
                                                                                <div class="form-group col-md-9">
                                                                                <label for="activity" class="label small px-1">Activity</label>
                                                                                <input type="text" class="form-control" id="action_type<?php echo $cnt ?>" name="activity" value="<?php echo $result->action_type ?>" required readonly disabled>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row pt-2">
                                                                            <div class="form-group col">
                                                                                <label for="table_name" class="label small px-1">Record ID</label>
                                                                                <input type="text" class="form-control" id="record_id<?php echo $cnt ?>" name="record_id" value="<?php echo $result->record_id ?>" required readonly disabled>
                                                                            </div>
                                                                            <div class="form-group col">
                                                                                <label for="table_name" class="label small px-1">Table Name</label>
                                                                                <input type="text" class="form-control" id="table_name<?php echo $cnt ?>" name="table_name" value="<?php echo $result->table_name ?>" required readonly disabled>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row pt-2">
                                                                            <div class="form-group col">
                                                                                <label for="date" class="label small px-1">Date</label>
                                                                                <input type="text" class="form-control" id="date<?php echo $cnt ?>" name="date" value="<?php echo $result->date ?>" required readonly disabled>
                                                                            </div>
                                                                            <div class="form-group col">
                                                                                <label for="time" class="label small px-1">Time</label>
                                                                                <input type="text" class="form-control" id="time<?php echo $cnt ?>" name="time" value="<?php echo $result->time ?>" required readonly disabled>
                                                                            </div>
                                                                        </div>
                                                                        <hr>
                                                                        <div class="row pt-2 pb-3">
                                                                            ...
                                                                            <div class="form-group col-md-6">
                                                                                ...
                                                                                <input type="text" class="form-control" id="name<?php echo $cnt ?>" name="name" value="<?php echo $result->full_name ?>" required readonly disabled>
                                                                            </div>
                                                                            <div class="form-group col-md-6">
